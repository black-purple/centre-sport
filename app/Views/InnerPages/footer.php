<footer class="bg-white border-b border-gray-300 shadow-lg mt-4">

    <div class=" flex flex-col md:flex-row justify-around mx-auto lg:px-32 px-16 md:pt-10 md:pb-5 space-y-2 " id="Contact">
        <div>
            <a href="<?= base_url('/') ?>"><img src=" public/img/svg/logo.svg" class="block h-20 lg:mr-8 md:mr-4" alt="" /></a>
        </div>
        <div class=" flex flex-col">
            <div class="font-semibold md:text-xl lg:text-lg text-md md:text-black  pb-2">Sport Club</div>
            <div class="pl-4">
                <div class="font-semibold text-sm lg:text-md  md:text-gray-500  hover:text-black"><a href="#Nous">À
                        propos de nous</a></div>
            </div>
        </div>
        <div class=" flex flex-col">
        ...
        <div class="flex flex-col">
            ...
            <div class="pl-4 pb-2">
                <div class="flex justify-center space-x-2 ">
                    <!-- Link 1 -->
                    <a href="#">
                        <img src="public/img/svg/icon-facebook.svg" alt="" class="lg:h-8 md:h-6 fill-current text-black   brightness-0 " />

                    </a>
                    <!-- Link 2 -->
                    <a href="#">
                        <img src="public/img/svg/icon-youtube.svg" alt="" class="lg:h-8 md:h-6  rounded-full  brightness-0 " />
                    </a>
                    <!-- Link 3 -->
                    <a href="#">
                        <img src="public/img/svg/icon-twitter.svg" alt="" class="lg:h-8 md:h-6 filter  brightness-0 " />
                    </a>
                    <!-- Link 4 -->
                    <a href="#">
                        <img src="public/img/svg/icon-pinterest.svg" alt="" class="lg:h-8 md:h-6  rounded-full  brightness-0 " />
                    </a>
                    <!-- Link 5 -->
                    <a href="#">
                        <img src="public/img/svg/icon-instagram.svg" alt="" class="lg:h-8 md:h-6  rounded-lg  brightness-0 " />
                    </a>
                </div>
            </div>
        </div>
